        ...
        <div className="relative h-56 overflow-hidden shrink-0">
          ...
          <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
            <div className="w-10 h-10 rounded-full bg-background/80 backdrop-blur-md flex items-center justify-center border border-[hsl(var(--award-gold)/0.3)] shadow-lg">
              <Trophy className="w-5 h-5 text-[hsl(var(--award-gold))]" />
            </div>
            <div className="flex items-center text-sm font-medium text-[hsl(var(--award-gold))] bg-background/80 backdrop-blur-md px-3 py-1 rounded-full border border-[hsl(var(--award-gold)/0.2)]">
